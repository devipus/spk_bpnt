...
<div class="row">
                ...
                <div class="message-p pn">
                  ...
                  <div class="row">
                    <div class="col-md-3 centered hidden-sm hidden-xs">
                      <img src="{{ asset('assets/img/ui-danro.jpg" class="img-circle" width="65">
                    </div>
                    <div class="col-md-9">
                      <p>
            ...
            <div class="row">
              ...
              <div class="col-md-4 mb">
                ...
                <div class="white-panel pn">
                  ...
                  <p><img src="{{ asset('assets/img/ui-zac.jpg" class="img-circle" width="50"></p>
                  <p><b>Zac Snider</b></p>
                  <div class="row">
                    <div class="col-md-6">
            ...
            <div class="row">
              ...
              <div class="col-lg-4 col-md-4 col-sm-4 mb">
                <div class="content-panel pn">
                  <div id="profile-02">
                    <div class="user">
                      <img src="{{ asset('assets/img/friends/fr-06.jpg" class="img-circle" width="80">
                      <h4>DJ SHERMAN</h4>
                    </div>
                  </div>
                  <div class="pr2-social centered">
                    <a href="{{ asset('assets/#"><i class="fa fa-twitter"></i></a>
                    <a href="{{ asset('assets/#"><i class="fa fa-facebook"></i></a>
                    <a href="{{ asset('assets/#"><i class="fa fa-dribbble"></i></a>
                  </div>
                </div>
                <!-- /panel -->
              </div>
          ...
          <div class="col-lg-3 ds">
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="{{ asset('assets/#">Paul Rudd</a> purchased an item.<br/>
                </p>
              </div>
            </div>
            <!-- Second Activity -->
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="{{ asset('assets/#">James Brown</a> subscribed to your newsletter.<br/>
                </p>
              </div>
            </div>
            <!-- Third Activity -->
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="{{ asset('assets/#">Diana Kennedy</a> purchased a year subscription.<br/>
                </p>
              </div>
            </div>
            <!-- Fourth Activity -->
            <div class="desc">
              ...
              <div class="details">
                <p>
                  ...
                  <br/>
                  <a href="{{ asset('assets/#">Brando Page</a> purchased a year subscription.<br/>
                </p>
              </div>
            </div>
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  <a href="{{ asset('assets/#">DIVYA MANIAN</a><br/>
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  <a href="{{ asset('assets/#">DJ SHERMAN</a><br/>
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  <a href="{{ asset('assets/#">DAN ROGERS</a><br/>
                  <muted>Available</muted>
                </p>
              </div>
            </div>
            ...
            <div class="desc">
              ...
              <div class="details">
                <p>
                  <a href="{{ asset('assets/#">Zac Sniders</a><br/>
                  <muted>Available</muted>
                </p>
              </div>
            </div>
