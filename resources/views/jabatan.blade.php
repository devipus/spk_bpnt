            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Jabatan
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Jabatan</a>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            ...
            if (save_method == 'add') url = "{{ url('jabatan') }}";
            else url = "{{ url('jabatan') . '/' }}" + id;
