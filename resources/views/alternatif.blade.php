            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Alternatif
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Alternatif</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="alternatif-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    table = $('#alternatif-table').DataTable({
        processing: true,
        serverSide: true,
        bLengthChange: true,
        iDisplayLength: 5,
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            ...
            if (save_method == 'add') url = "{{ url('alternatif') }}";
            else url = "{{ url('alternatif') . '/' }}" + id;
