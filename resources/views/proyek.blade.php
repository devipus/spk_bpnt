            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h4>Data Proyek
                        ...
                        <a onclick="addForm()" class="btn btn-primary pull-right" style="margin-top: -8px;">Add Proyek</a>

                       
                    </h4>
                </div>
                <div class="panel-body">
                    <table id="proyek-table" class="table table-striped">
                        <thead>
                            <tr>
...
$(document).ready(function() {
    ...
    var validator= $('#modal-form form').validator();
        ...
        if (!e.isDefaultPrevented()) {
            var id = $('#id_proyek').val();
            if (save_method == 'add') url = "{{ url('proyek') }}";
            else url = "{{ url('proyek') . '/' }}" + id;
